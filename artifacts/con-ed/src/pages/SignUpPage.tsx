  ...
  return (
    <div className="flex min-h-screen w-full bg-slate-50">
      ...
      <div className="hidden flex-1 bg-secondary flex-col items-center justify-center lg:flex p-12 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10 bg-[url('https://images.unsplash.com/photo-1544161515-4ab6ce6db874?auto=format&fit=crop&q=80')] bg-cover bg-center"></div>
