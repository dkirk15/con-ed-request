...
- Start the managed `artifacts/api-server: API Server` workflow before E2E runs; the frontend can serve while authentication and API-backed tests hang or fail if the API workflow is stopped.
