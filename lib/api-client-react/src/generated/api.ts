 ...
 */
export const getSettings = async ( options?: RequestInit): Promise<ConEdSettings> => {

  return customFetch<ConEdSettings>(getGetSettingsUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetSettingsQueryOptions = <TData = Awaited<ReturnType<typeof getSettings>>, TError = ErrorType<ErrorEnvelope>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getSettings>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export type GetSettingsQueryError = ErrorType<ErrorEnvelope>
...
export function useGetSettings<TData = Awaited<ReturnType<typeof getSettings>>, TError = ErrorType<ErrorEnvelope>>(
 ...
 */
export const updateSettings = async (conEdSettingsUpdate: ConEdSettingsUpdate, options?: RequestInit): Promise<ConEdSettings> => {

  return customFetch<ConEdSettings>(getUpdateSettingsUrl(),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(conEdSettingsUpdate)
  }
);}
...
export const getUpdateSettingsMutationOptions = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateSettings>>, TError,{data: BodyType<ConEdSettingsUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateSettings>>, TError,{data: BodyType<ConEdSettingsUpdate>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateSettings>>, {data: BodyType<ConEdSettingsUpdate>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateSettingsMutationBody = BodyType<ConEdSettingsUpdate>
...
export const useUpdateSettings = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateSettings>>, TError,{data: BodyType<ConEdSettingsUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        {data: BodyType<ConEdSettingsUpdate>},
        TContext
      > => {
