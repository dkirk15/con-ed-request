...
export const ListRequestsResponse = zod.object({
  ...
  "courseDates": zod.string().nullish().describe('Legacy free-text course dates retained for existing requests.'),
 ...
 */
export const createRequestBodyCourseStartDateRegExp = new RegExp('^\\d{4}-\\d{2}-\\d{2}$');
export const createRequestBodyCourseEndDateRegExp = new RegExp('^\\d{4}-\\d{2}-\\d{2}$');
...
export const CreateRequestBody = zod.object({
  ...
  "courseProvider": zod.string().nullish(),
  "courseUrl": zod.string().url().nullish(),
  "courseStartDate": zod.string().regex(createRequestBodyCourseStartDateRegExp).nullish(),
  "courseEndDate": zod.string().regex(createRequestBodyCourseEndDateRegExp).nullish(),
  "deliveryMethod": zod.union([zod.literal('in_person'),zod.literal('virtual'),zod.literal('hybrid'),zod.literal(null)]).nullish(),
...
export const updateRequestBodyCourseStartDateRegExp = new RegExp('^\\d{4}-\\d{2}-\\d{2}$');
export const updateRequestBodyCourseEndDateRegExp = new RegExp('^\\d{4}-\\d{2}-\\d{2}$');
...
export const UpdateRequestBody = zod.object({
  ...
  "courseProvider": zod.string().nullish(),
  "courseUrl": zod.string().url().nullish(),
  "courseStartDate": zod.string().regex(updateRequestBodyCourseStartDateRegExp).nullish(),
  "courseEndDate": zod.string().regex(updateRequestBodyCourseEndDateRegExp).nullish(),
  "deliveryMethod": zod.union([zod.literal('in_person'),zod.literal('virtual'),zod.literal('hybrid'),zod.literal(null)]).nullish(),
  "courseDates": zod.string().nullish(),
  "ceuCount": zod.number().nullish(),
  "location": zod.string().nullish(),
 ...
 */
export const ReopenRequestParams = zod.object({
  "requestId": zod.coerce.number()
})

export const ReopenRequestResponse = zod.object({
  "id": zod.number(),
  "employeeId": zod.number(),
  "employeeName": zod.string().nullish(),
  "employeeEmail": zod.string().nullish(),
...
export const SignRepaymentGuaranteeResponse = zod.object({
  "id": zod.number(),
  "requestId": zod.number(),
  "employeeId": zod.number(),
  "signedName": zod.string(),
...
export const SubmitReceiptResponse = zod.object({
  "id": zod.number(),
  "requestId": zod.number(),
  "fileUrl": zod.string(),
  "fileName": zod.string().nullish(),
...
export const GetManagerDashboardResponse = zod.object({
  ...
  "myRecentRequests": zod.array(zod.object({
  "id": zod.number(),
  "employeeId": zod.number(),
  "employeeName": zod.string().nullish(),
  "employeeEmail": zod.string().nullish(),
